  ...
  const contactDetails = [
    {
      icon: <FaMapMarkedAlt />,
      title: "Address",
      value: "No 1, Jinna street, Udayendiram, Vaniyambadi, Tirupattur-635 754",
    },
    {
      icon: <FaEnvelope />,
      title: "Email",
      value: "akashna049@gmail.com",
    },
    {
      icon: <FaPhone />,
      title: "Number",
      ...
      <section className="contact">
        ...
        <div className="row">
          <div className="info-container">
            ...
            <div className="share">
              <a href="https://www.linkedin.com/in/naveen-akash-790b74274/" target="_blank"> <FaLinkedin className="mediaIcons" /> </a>
              <a href="mailto:akashna049@gmail.com"> <FaMailBulk className="mediaIcons" /> </a>
              <a href="https://github.com/naveen-akash-na" target="_blank" > <FaGithub className="mediaIcons" /> </a>
